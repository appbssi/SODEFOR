...
function AppSidebarContent() {
    ...
    return (
        <div className="text-gray-800 dark:text-white">
            <div className="flex p-2 bg-white dark:bg-gray-800">
            ...
            <div className="flex justify-center mt-4">
                <div>
                    ...
                    />
                    <p className="font-bold text-base text-gray-500 dark:text-gray-400 pt-2 text-center w-24">Utilisateur</p>
                </div>
            </div>
            <div>
                <ul className="mt-6 leading-10">
                    ...
                    <li className="relative px-2 py-1">
                        ...
                        >
                            <span className="inline-flex items-center text-sm font-semibold hover:text-green-400">
...
export function AppSidebar() {
  ...
  return (
    <>
        ...
        <aside
            className="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-white dark:bg-gray-900 md:hidden"
            style={{ display: openMobile ? 'block' : 'none' }}
            onClick={() => setOpenMobile(false)}
        >
            <AppSidebarContent />
        </aside>
        <aside className="z-20 flex-shrink-0 hidden w-60 pl-2 overflow-y-auto bg-white dark:bg-gray-800 md:block">
            <AppSidebarContent />
        </aside>
    </>
  );
