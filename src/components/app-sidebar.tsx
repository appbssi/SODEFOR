            ...
            <div>
                <ul className="mt-6 leading-10">
                        ...
                        <li key={item.href} className="relative px-2 py-1 ">
                            <Link 
                                ...
                                className={cn(
                                    ...
                                    pathname.startsWith(item.href) ? "text-primary-foreground" : "text-gray-400 hover:text-primary-foreground"
                                )}>
                    ...
                    <li className="relative px-2 py-1">
                        ...
                        >
                            <span className="inline-flex items-center  text-sm font-semibold text-gray-400 hover:text-primary-foreground">
...
export function AppSidebar() {
  ...
  return (
    <>
      ...
      <aside
        className="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-gray-800 md:hidden"
